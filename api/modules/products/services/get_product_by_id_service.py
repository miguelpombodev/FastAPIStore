...
from ..model.validations.product_brand import ProductBrand
from ..model.validations.product_type import ProductType
from ..model.validations.product_colors import ProductColors
...
class GetProductByIDService:
    ...
    def execute(self, product_id: str) -> FullDetailProduct:
        ...
        orm_result = self._repository.get_by_id(product_id).__dict__
